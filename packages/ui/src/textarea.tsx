...
const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(
  ({ className, ...props }, ref) => {
    return (
      <textarea
        className={cn(
          'flex min-h-[120px] w-full rounded-md overflow-hidden border-2 border-purple-500/30 bg-slate-900/50 backdrop-blur-sm px-4 py-3 text-sm text-white transition-all duration-300 resize-y',
