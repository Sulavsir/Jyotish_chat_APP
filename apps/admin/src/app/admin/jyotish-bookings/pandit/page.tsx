...
export default function PanditBookingsPage() {
  ...
  const { data, isLoading, refetch, isFetching } = useQuery({
    ...
    queryFn: () => adminApi.jyotishBookings.list({ type: JyotishBookingType.PANDIT }),
  });
  ...
  const updateStatusMutation = useMutation({
    ...
    onSuccess: async () => {
      await queryClient.invalidateQueries({ queryKey: ADMIN_QUERY_KEYS.JYOTISH_BOOKINGS.LIST({ type: JyotishBookingType.PANDIT }) });
        ...
        <div className="cosmic-card rounded-xl overflow-hidden">
          <AdminTable
            ...
            emptyState={{
              ...
              title: 'No Pandit Ji booking requests',
