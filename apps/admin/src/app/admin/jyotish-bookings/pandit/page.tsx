...
export default function PanditBookingsPage() {
  ...
  const {
    ...
    queryKey: [
      ...ADMIN_QUERY_KEYS.JYOTISH_BOOKINGS.LIST(ADMIN_JYOTISH_BOOKING_LIST_FILTER.PANDIT),
      currentPage,
      debouncedSearch,
      statusFilter,
  ...
  const updateStatusMutation = useMutation({
    ...
    onSuccess: async () => {
      await queryClient.invalidateQueries({
        queryKey: ADMIN_QUERY_KEYS.JYOTISH_BOOKINGS.LIST(ADMIN_JYOTISH_BOOKING_LIST_FILTER.PANDIT),
      });
  ...
  return (
    <>
      <JyotishBookingDetailDialog
        ...
        serviceLabel="Pujari Ji"
        categoryLabel="Puja Category"
      />
