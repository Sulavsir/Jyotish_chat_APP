...
const PAYMENT_RELATED_STAT_TITLES = new Set([
  'Total Earnings (Astrologers)',
  "Today's Earnings (Astrologers)",
  'Total Loaded (Platform)',
...
export default function DashboardPage() {
  ...
  const quickActions = useMemo(() => {
    ...
    return all.filter((a) => a.route !== ADMIN_ROUTES.EARNINGS);
  }, [canViewPaymentStats]);
