...
export const createRequest = async (
  ...
  try {
    ...
    sendSuccess(res, request, 'Instant chat request created successfully', HTTP_STATUS.CREATED);
  } catch (error: any) {
    sendError(res, error.message || 'Failed to create instant chat request', HTTP_STATUS.BAD_REQUEST);
  }
};
...
export const getPendingRequests = async (
  ...
  try {
    ...
    sendSuccess(res, requests, 'Pending requests fetched successfully');
  } catch (error: any) {
    sendError(res, error.message || 'Failed to fetch pending requests', HTTP_STATUS.INTERNAL_SERVER_ERROR);
  }
};
...
export const acceptRequest = async (
  ...
  try {
    ...
    sendSuccess(res, result, 'Request accepted successfully');
  } catch (error: any) {
...
export const getMyActiveRequest = async (
  ...
  try {
    ...
    sendSuccess(res, request, 'Active request fetched successfully');
  } catch (error: any) {
    sendError(res, error.message || 'Failed to fetch active request', HTTP_STATUS.INTERNAL_SERVER_ERROR);
  }
};
...
export const checkAstrologerStatus = async (
  ...
  try {
    ...
    sendSuccess(res, { isBusy }, 'Status checked successfully');
  } catch (error: any) {
