  ...
  return (
    <DashboardLayout>
      <div className="container mx-auto px-4 py-8 max-w-4xl space-y-6">
        ...
        {/* Master Toggle */}
        <Card className="p-6 bg-gradient-to-br from-purple-900/40 to-indigo-900/40 border-purple-500/20">
        ...
        <Card className="p-6 bg-gray-800/50 border-gray-700">
          ...
          <div className="space-y-4">
            ...
            <SettingToggle
              ...
              label="Consultations"
              description="Reminders and updates about your consultations"
  ...
  return (
    <div className="flex items-center justify-between py-3 border-b border-gray-700 last:border-0">
      <div className="flex items-center gap-3">
        <div className={`p-2 rounded-lg ${checked && !disabled ? 'bg-purple-600 text-white' : 'bg-gray-700 text-gray-400'}`}>
          {icon}
        </div>
        <div>
