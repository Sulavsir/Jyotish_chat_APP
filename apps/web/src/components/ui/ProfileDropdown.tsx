    ...
    <>
      ...
      >
        {imageUrl ? (
          <div
            className={cn(
              'w-10 h-10 rounded-full overflow-hidden border-2 cursor-pointer hover:scale-110 transition-transform',
              theme.border
            )}
          >
            <Image
          ...
          <div
            className={cn(
              'w-10 h-10 rounded-full bg-gradient-to-br flex items-center justify-center text-white font-bold cursor-pointer hover:scale-110 transition-transform',
              `${theme.gradient}`
            )}
          >
